...
%\VignetteDepends{survcomp, mclust}
%\VignetteSuggests{GeneMeta}
%\VignetteImports{amap, gplots}
...
tt <- as.data.frame(tt)
labeltext <- cbind(c("Dataset", datasetListF),c(rep(myspace,length(datasetListF)+1)))
...
forestplot.surv(labeltext=labeltext, mean=r.mean, lower=r.lower, upper=r.upper, zero=0.5, align=c("l"), graphwidth=unit(2, "inches"), x.ticks=seq(0.4,0.9,0.1), col=meta.colors(box="royalblue",line="darkblue",zero="firebrick",summary="black"),box.size=bs, clip=c(0.35,0.9), is.summary=c(rep(FALSE,7),TRUE), xlab="NPI Concordance Index")
@
...
forestplot.surv(labeltext=labeltext, mean=r.mean, lower=r.lower, upper=r.upper, zero=0.5, align=c("l"), graphwidth=unit(2, "inches"), x.ticks=seq(0.4,0.9,0.1), col=meta.colors(box="royalblue",line="darkblue",zero="firebrick",summary="black"),box.size=bs, clip=c(0.4,0.9), is.summary=c(rep(FALSE,7),TRUE), xlab="AURKA Concordance Index")
@
...
forestplot.surv(labeltext=labeltext, mean=r.mean, lower=r.lower, upper=r.upper, zero=0.5, align=c("l"), graphwidth=unit(2, "inches"), x.ticks=seq(0.4,0.9,0.1), col=meta.colors(box="royalblue",line="darkblue",zero="firebrick",summary="black"),box.size=bs, clip=c(0.4,0.9), is.summary=c(rep(FALSE,7),TRUE), xlab="GGI Concordance Index")
@
...
forestplot.surv(labeltext=labeltext, mean=r.mean, lower=r.lower, upper=r.upper, zero=0.5, align=c("l"), graphwidth=unit(2, "inches"), x.ticks=seq(0.4,0.9,0.1), col=meta.colors(box="royalblue",line="darkblue",zero="firebrick",summary="black"),box.size=bs, clip=c(0.4,1), is.summary=c(rep(FALSE,7),TRUE), xlab="GENIUS Concordance Index")
@

<<forestplotOverall,fig=TRUE,echo=FALSE>>=
## Overall Forestplot
mybigspace <- "       "
...
labeltext <- cbind(c("Risk Prediction","NPI","AURKA","GGI","GENIUS"),
                      c("",rep(mybigspace,4)),c("",rep(mybigspace,4)),c("",rep(mybigspace,4)))
bs <- rep(0.5, nrow(labeltext))
...
forestplot.surv(labeltext=labeltext, mean=r.mean, lower=r.lower, upper=r.upper, zero=0.5, align=c("l"), graphwidth=unit(1, "inches"), x.ticks=seq(0.45,0.75,0.1), col=meta.colors(box="royalblue", line="darkblue", zero="firebrick", summary=c(NA,"darkgreen","orange","purple","darkred")), box.size=bs, clip=c(0.4,0.9), is.summary=c(rep(TRUE,4)), xlab="Overall Concordance Index")
@
